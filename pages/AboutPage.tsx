      ...
      <main className="w-full max-w-5xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-6 sm:p-10 lg:p-12 border border-gray-200/50 dark:border-gray-700/50 transition-colors duration-200">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12">
            <section>
              <h2 className="text-2xl sm:text-3xl font-bold text-sky-600 dark:text-sky-400 mb-4">Our Features</h2>
              <div className="space-y-6 text-gray-700 dark:text-gray-300">
                <div>
                  <h3 className="font-bold text-lg text-[#2E1E1E] dark:text-white">Virtual Photoshoot (Seamless Swap)</h3>
                ...
                <div>
                  <h3 className="font-bold text-lg text-[#2E1E1E] dark:text-white">E-commerce Asset Generator (Core Extraction)</h3>
                ...
                <div>
                  <h3 className="font-bold text-lg text-[#2E1E1E] dark:text-white">Perfect Product Forge (Catalog | Forged)</h3>
            ...
            <section>
              <h2 className="text-2xl sm:text-3xl font-bold text-sky-600 dark:text-sky-400 mb-4">About Us</h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
